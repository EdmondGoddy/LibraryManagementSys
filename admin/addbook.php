                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="BookPhoto"><b>Book Photo</b></label>
                                            <div class="controls">
                                                <input type="file" id="BookPhoto" name="book_photo" placeholder="Number of Copies" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Book"><b>Book</b></label>
                                            <div class="controls">
                                                <input type="file" id="Book" name="book" placeholder="Number of Copies" class="span8" required>
                                            </div>
                                        </div>
...
if(isset($_POST['submit']))
{
    ...
    if (move_uploaded_file($_FILES["book_photo"]["tmp_name"],"C:/xampp/htdocs/LMS_Project/admin/book photos/" . $_FILES["book_photo"]["name"])) {
        $book_photo=$_FILES["book_photo"]["name"];  
        
        if (move_uploaded_file($_FILES["book"]["tmp_name"],"C:/xampp/htdocs/LMS_Project/admin/books/" . $_FILES["book"]["name"])) {
            $book=$_FILES["book"]["name"];  
        }
    }    
    $sql1="insert into LMS.book (Book_photo,Book,Title,Publisher,Year,Availability) values ('$book_photo','$book','$title','$publisher','$year','$availability')";
