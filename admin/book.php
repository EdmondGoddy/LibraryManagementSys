                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $name ?></td> 
                                      <td><a href="./books/<?php echo $book ?>" target="_blank" rel="noopener noreferrer"> 
                                        <img src="./book photos/<?php echo $book_photo ?>" alt="" sizes="" srcset="" width="150" height="100"> 
                                      </a></td>
                                      <!--<td><a href="http://" target="_blank" rel="noopener noreferrer"> 
                                        <?php #echo $book_photo ?> 
                                      </a></td>-->
